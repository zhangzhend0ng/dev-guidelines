...
|----|-------|----------|------|--------|---------|-------------|
| common-ai-evaluation-regression | [AI Evaluation and Regression Strategy Checklist](common/ai/ai-evaluation-and-regression-strategy.md) | common | C | draft | 2026.06 | `**/evals/**`, `**/*eval*.py`, `**/*regression*.py` |
| common-ai-assisted-cpp-development | [AI-Assisted C++ Development Checklist](common/ai/ai-assisted-cpp-development.md) | common | C | draft | 2026.06 | `**/ai/**/*.cpp`, `**/ai/**/*.h`, `**/ai/**/*.hpp` |
...
| ID | Title | Language | Tier | Status | Version | Apply Globs |
|----|-------|----------|------|--------|---------|-------------|
| python-asyncio-cancellation | [Python asyncio Cancellation Checklist](python/concurrency/asyncio-cancellation.md) | python | C | draft | 2026.06 | `**/asyncio/**`, `**/*async*.py` |
...
| python-packaging-dependency-management | [Python Packaging and Dependency Management Checklist](python/packaging/dependency-management.md) | python | C | draft | 2026.06 | `**/pyproject.toml`, `**/setup.py`, `**/setup.cfg`, `**/requirements*.txt`, `**/environment.yml` |
...
| ID | Title | Language | Tier | Status | Version | Apply Globs |
|----|-------|----------|------|--------|---------|-------------|
| cpp-move-semantics | [Move Semantics and Rule of Five Checklist](cpp/memory/move-semantics.md) | cpp | N | draft | 2026.06 | `**/memory/**`, `**/*move*` |
| cpp-raii | [RAII and Resource Management Checklist](cpp/memory/raii.md) | cpp | N | draft | 2026.05 | `**/memory/**`, `**/*raii*`, `**/*resource*` |
| cpp-ownership | [Smart Pointer and Ownership Semantics Checklist](cpp/memory/ownership.md) | cpp | N | draft | 2026.05 | `**/memory/**`, `**/*owner*`, `**/smart_ptr*`, `**/*unique_ptr*`, `**/*shared_ptr*` |
